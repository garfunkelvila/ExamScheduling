<div class="">
	<div class="w3-bar my-blue w3-card-2" id="myNavbar">
		...
		<div class="w3-right w3-hide-small">
			...
			<a href="manage_exam_schedule.php" class="w3-bar-item w3-padding w3-button">Endorse Schedules</a>
			<a href="manage_subjects.php" class="w3-bar-item w3-padding w3-button">Courses and Subjects</a>
			<a href="manage_professors.php" class="w3-bar-item w3-padding w3-button">Professors</a>
			<a href="manage_sections.php" class="w3-bar-item w3-padding w3-button">Sections</a>
			<div class="w3-dropdown-hover">
				...
				<div class="w3-dropdown-content w3-bar-block w3-card-4" style="right: 0;">
					...
					<a href="change_dept_info.php" class="w3-bar-item w3-padding w3-button"><i class="far fa-edit" aria-hidden="true"></i> Department Information</a>
...
<nav class="w3-sidebar w3-bar-block my-light-blue w3-card-2 w3-animate-left w3-hide-medium w3-hide-large" style="display:none; z-index: 3;" id="mySidebar">
	...
	<a href="manage_sections.php" class="w3-bar-item w3-padding w3-button">Sections</a>
	<hr>
	<a href="change_dept_info.php" class="w3-bar-item w3-padding w3-button">Department Information</a>
