<div class="">
	<div class="w3-bar my-blue w3-card-2" id="myNavbar">
		...
		<div class="w3-right w3-hide-small">
			...
			<a href="exam_dates.php" class="w3-bar-item w3-padding w3-button">Exam Dates</a>
			<a href="unscheduled_subjects.php" class="w3-bar-item w3-padding w3-button">Endorsed Sections</a>
			<a href="scheduled_subjects.php" class="w3-bar-item w3-padding w3-button">Scheduled Sections</a>
