...
<div class="">
	<div class="w3-bar my-blue w3-card-2" id="myNavbar">
		...
		<a class="w3-bar-item w3-padding">Admin : <?php echo $LoggedInName ?></a>
		...
		<div class="w3-right w3-hide-small">
			...
			<a href="manage_subjects.php" class="w3-bar-item w3-padding w3-button">Manage Subjects</a>
			<a href="manage_exam_schedule.php" class="w3-bar-item w3-padding w3-button">Exam Schedule</a>
