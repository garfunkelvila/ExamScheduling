...
<script type="text/javascript">
	function fillSubjects(){
		$.ajax({
			url: "ajax_table_popup_guardian_monitor.php",
			data: {
	...
	function updateSudgestion(){
		...
		$.ajax({
			url: "ajax_select_users_popup_register_guardian.php",
			dataType: "json",
			data: {
				q: $("#txbGuardianId").val(),
				idNum: '<?php echo $_REQUEST['idNum']; ?>'
	...
	function addStudent(q){
		$.ajax({
			url: "ajax_insert_guardian_monitor.php",
			data: {
				studentId: q,
	...
	function removeStudent(e){
		$.ajax({
			url: "ajax_delete_from_guardian_monitor.php",
			data: {
				monitorId: e
			},
			success: function(response){
