...
<body>
	...
	<div class="w3-container" style="max-width: 5in;">
		...
		<form class="w3-card-4 w3-padding w3-container" onsubmit="validateIdNumber(); return registerIt();">
			...
			$.ajax({
				...
				success: function(response){
					...
					if(response.sucess){
						...
						if (confirm("ITS account sucesfully registered! want to add more?") == true) {
							location.reload();
						} else {
							window.close();
						} 
