...
<body>
	...
	<script type="text/javascript">
		...
		function updateOptCourse(q){
			...
			$.ajax({
				url: "ajax_fragment_option_course_names.php",
				data: { dept: q },
		...
		function updateOptLevels(){
			...
			$.ajax({
				url: "ajax_fragment_option_subject_levels.php",
				data: {
					course: e
				},
				success: function(response){
		...
		function updateOptSubjects(){
			...
			$.ajax({
				url: "ajax_fragment_option_subject_names.php",
				data: {
		...
		function updateOptSections(){
			...
			$.ajax({
				url: "ajax_fragment_option_subject_level_sections.php",
				data: {
					course: $("#courseContainer").val(),
					level:  $("#levelContainer").val(),
		...
		function fillSubjContainer(){
			...
			$.ajax({
				url: "ajax_fragment_table_pre_reg_subjects.php",
				data: { idNum: tmpId },
				success: function(response){
		...
		function registerStudent(){
			$.ajax({
				url: "ajax_json_insert_student.php",
				dataType: "json",
				data: {
					tId: tmpId,
		...
		function addToSection(){
			...
			$.ajax({
				url: "ajax_json_insert_pre_reg_class.php",
				data: {
		...
		function removeFromSection(e){
			$.ajax({
				url: "ajax_json_delete_from_class_pre_reg.php",
				data: {
					classId: e
				},
				success: function(response){
